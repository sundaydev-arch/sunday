...
1. If `.agents/skills/seo-audit/references/sunday-site.md` exists, read it (Sunday portfolio defaults).
2. If `.claude/product-marketing-context.md` exists, read it.
